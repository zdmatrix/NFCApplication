...
public class NFCMsgCode {
	public static final int nNOT_SUPPORT_NFC = -1;
	public static final int nNOT_OPEN_NFC = 0;
	...
	public static final String sSUPPORT_NFC = "NFC Work Now!";
	public static final String sUNKNOWN_ERR = "Unknown Error!";
